...
CORNERS = {
    ...
    /* top images*/
    TL : {src:'.image/topl.png', sizing: 'scale'},
    TM : {src:'.image/topm.png', sizing: 'crop'},
    TR : {src:'.image/topr.png', sizing: 'scale'},
    
    /* middle images */
    ML : {src:'.image/midl.png', sizing: 'crop'},
    MR : {src:'.image/midr.png', sizing: 'crop'},
    
    /* bottom images */
    BL : {src:'.image/botl.png', sizing: 'scale'},
    BM : {src:'.image/botm.png', sizing: 'crop'},
    BR : {src:'.image/botr.png', sizing: 'scale'}
}
